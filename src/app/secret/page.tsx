          ...
          <div className="animate-fade-up">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                ...
                onClick={() => setStage("no")}
                className="px-10 py-4 rounded-2xl bg-gradient-to-r from-gray-300 to-gray-400 text-white font-bold text-lg shadow-lg shadow-gray-200/50 hover:shadow-xl transition-all duration-300"
                style={{
          ...
          <div className="animate-fade-up">
            ...
            <div className="space-y-4 max-w-xs mx-auto">
              <input
                ...
                className="w-full px-5 py-4 rounded-2xl bg-white border border-gray-200 text-gray-700 text-center font-medium placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-rose-300/50 focus:border-rose-300 shadow-sm transition-all"
              />
              <button
                onClick={() => setStage("reveal")}
                disabled={!guess.trim()}
                className="w-full px-6 py-4 rounded-2xl bg-gradient-to-r from-rose-400 to-pink-500 text-white font-bold text-lg shadow-lg shadow-rose-200/50 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 active:translate-y-0 disabled:opacity-40 disabled:hover:translate-y-0 disabled:hover:shadow-lg"
              >
                Submit 💌
              </button>
            </div>
